...
javascript:(function(){open('x-turms:'+encodeURIComponent(document.URL)+'?'+encodeURIComponent(document.title)+'?'+encodeURIComponent(document.selection.createRange().toString())).focus();})();
